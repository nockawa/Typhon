...
{
    private ref EpochChunkAccessor _compRevTableAccessor;
    ...
    public unsafe RevisionEnumerator(ref EpochChunkAccessor compRevTableAccessor, int compRevFirstChunkId, bool exclusiveAccess, bool goToFirstItem)
    {
