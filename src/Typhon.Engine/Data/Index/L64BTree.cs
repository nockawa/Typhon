...
public abstract class L64BTree<TKey, TStore> : BTree<TKey, TStore> where TStore : struct, IPageStore where TKey : unmanaged
{
...
public class L64MultipleBTree<TKey, TStore> : L64BTree<TKey, TStore> where TStore : struct, IPageStore where TKey : unmanaged
{
...
public class LongSingleBTree<TStore> : L64BTree<long, TStore> where TStore : struct, IPageStore
{
...
public class LongMultipleBTree<TStore> : L64MultipleBTree<long, TStore> where TStore : struct, IPageStore
{
...
public class ULongSingleBTree<TStore> : L64BTree<long, TStore> where TStore : struct, IPageStore
{
...
public class ULongMultipleBTree<TStore> : L64MultipleBTree<long, TStore> where TStore : struct, IPageStore
{
...
public class DoubleSingleBTree<TStore> : L64BTree<double, TStore> where TStore : struct, IPageStore
{
...
public class DoubleMultipleBTree<TStore> : L64MultipleBTree<double, TStore> where TStore : struct, IPageStore
{
