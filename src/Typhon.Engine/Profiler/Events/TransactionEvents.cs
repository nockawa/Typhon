...
/// </summary>
[TraceEvent(TraceEventKind.TransactionRollback, Codec = typeof(TransactionEventCodec), FactoryName = "BeginTransactionPersist")] public ref partial struct TransactionPersistEvent
{
    [BeginParam]
    public long Tsn;
