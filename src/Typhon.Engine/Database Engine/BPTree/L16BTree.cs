...
public abstract class L16BTree<TKey> : BTree<TKey> where TKey : unmanaged
{
    unsafe public class L16NodeStorage : BaseNodeStorage
    {
        ...
        public override void MergeLeft(NodeWrapper left, NodeWrapper right, ChunkRandomAccessor accessor)
        {
            ...
            if (leftChunk.Count + right.GetCount(accessor) > Index16Chunk.Capacity)
            ...
            {
                bool copyIsOnePiece = end + right.GetCount(accessor) <= Index16Chunk.Capacity;
        ...
        public NodeWrapper SplitRight(ref Index16Chunk left, NodeStates states, ChunkRandomAccessor accessor)
        {
