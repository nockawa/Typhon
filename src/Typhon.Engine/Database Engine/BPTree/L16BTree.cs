...
public abstract class L16BTree<TKey> : BTree<TKey> where TKey : unmanaged
{
    ...
    protected L16BTree(ChunkBasedSegment segment, ref ChunkAccessor accessor, bool load = false) : base(segment, ref accessor, load)
    {
    }
}
...
{
    public L16MultipleBTree(ChunkBasedSegment segment, ref ChunkAccessor accessor, bool load = false) : base(segment, ref accessor, load)
    {
    }
...
{
    public CharSingleBTree(ChunkBasedSegment segment, ref ChunkAccessor accessor, bool load = false) : base(segment, ref accessor, load)
    {
    }
}
...
{
    public CharMultipleBTree(ChunkBasedSegment segment, ref ChunkAccessor accessor, bool load = false) : base(segment, ref accessor, load)
    {
    }
}
...
{
    public ByteSingleBTree(ChunkBasedSegment segment, ref ChunkAccessor accessor, bool load = false) : base(segment, ref accessor, load)
    {
    }
}
...
{
    public ByteMultipleBTree(ChunkBasedSegment segment, ref ChunkAccessor accessor, bool load = false) : base(segment, ref accessor, load)
    {
    }
}
...
{
    public ShortSingleBTree(ChunkBasedSegment segment, ref ChunkAccessor accessor, bool load = false) : base(segment, ref accessor, load)
    {
    }
}
...
{
    public ShortMultipleBTree(ChunkBasedSegment segment, ref ChunkAccessor accessor, bool load = false) : base(segment, ref accessor, load)
    {
    }
}
public class UByteSingleBTree : L16BTree<byte>
{
    public UByteSingleBTree(ChunkBasedSegment segment, ref ChunkAccessor accessor, bool load = false) : base(segment, ref accessor, load)
    {
    }
}
...
{
    public UByteMultipleBTree(ChunkBasedSegment segment, ref ChunkAccessor accessor, bool load = false) : base(segment, ref accessor, load)
    {
    }
}
...
{
    public UShortSingleBTree(ChunkBasedSegment segment, ref ChunkAccessor accessor, bool load = false) : base(segment, ref accessor, load)
    {
    }
}
...
{
    public UShortMultipleBTree(ChunkBasedSegment segment, ref ChunkAccessor accessor, bool load = false) : base(segment, ref accessor, load)
    {
    }
}