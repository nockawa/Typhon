...
public abstract class L64BTree<TKey> : BTree<TKey> where TKey : unmanaged
{
    unsafe public class L64NodeStorage : BaseNodeStorage
    {
        ...
        public override void MergeLeft(NodeWrapper left, NodeWrapper right, ChunkRandomAccessor accessor)
        {
            ...
            if (leftChunk.Count + right.GetCount(accessor) > Index64Chunk.Capacity)
            ...
            {
                bool copyIsOnePiece = end + right.GetCount(accessor) <= Index64Chunk.Capacity;
        ...
        public NodeWrapper SplitRight(ref Index64Chunk left, NodeStates states, ChunkRandomAccessor accessor)
        {
