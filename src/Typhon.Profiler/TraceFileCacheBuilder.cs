...
/// Paired with <see cref="TraceFileCacheReader"/> in this same assembly so every consumer (Workbench, engine tests,
/// future tooling) depends on them via ProjectReference rather than copying the source.
/// </summary>
