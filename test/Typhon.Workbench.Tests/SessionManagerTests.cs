...
public sealed class SessionManagerTests
{
    ...
    {
        var session = new AttachSession(Guid.NewGuid(), "localhost:5100");
    ...
    public void Count_ReflectsActiveSessionCount()
    {
        ...
        var s1 = _manager.Create(new AttachSession(Guid.NewGuid(), "a"));
        var s2 = _manager.Create(new AttachSession(Guid.NewGuid(), "b"));
    ...
    public void ConcurrentAccess_DoesNotThrow()
    {
        ...
        {
            var s = new AttachSession(Guid.NewGuid(), "concurrent");
            _manager.Create(s);
