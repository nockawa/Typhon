...
namespace Typhon.Engine.Tests.Database_Engine
{
    class BtreeTests
    {
        ...
        unsafe public void CheckMultipleTreeBigAmount()
        {
            ...
            Log.Logger.Error("Total insertion count {gc}, chunk allocated {cc}", gc, segment.AllocatedChunkCount);
            ...
            Log.Logger.Error("Remove half key/values, chunk allocated {cc}", segment.AllocatedChunkCount);
            ...
            Log.Logger.Error("Remove half key/values, chunk allocated after collect {cc}", segment.AllocatedChunkCount);
